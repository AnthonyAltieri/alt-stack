...
from alt_stack_openapi_pydantic.to_python import convert_schema_to_pydantic_string
...
def test_object_additional_properties_type() -> None:
    assert (
        convert_schema_to_pydantic_string(
            {"type": "object", "additionalProperties": {"type": "string"}}
        )
        == "dict[str, Annotated[str, Field(strict=True)]]"
    )
