...
def generate_route_schema_names(route: RouteInfo) -> RouteSchemaNames:
    ...
    if success_statuses:
        result.response_schema_name = build_route_schema_name(
            route.path,
            route.method,
            "Response",
        )
    ...
    if path_params:
        result.params_schema_name = build_route_schema_name(
            route.path,
            route.method,
            "Params",
        )
    ...
    if query_params:
        result.query_schema_name = build_route_schema_name(
            route.path,
            route.method,
            "Query",
        )
    ...
    if header_params:
        result.headers_schema_name = build_route_schema_name(
            route.path,
            route.method,
            "Headers",
        )
    ...
    if route.request_body is not None:
        result.body_schema_name = build_route_schema_name(
            route.path,
            route.method,
            "Body",
        )
