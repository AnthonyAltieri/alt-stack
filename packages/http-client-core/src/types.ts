...
/**
 * Request to be executed by the HTTP executor
 */
...
/**
 * Response from the HTTP executor
 */
export interface ExecuteResponse<TRawResponse = unknown> {
  status: number;
  statusText: string;
  data: unknown;
  raw: TRawResponse;
...
/**
 * Interface for HTTP executors (fetch, ky, etc.)
 */
export interface HttpExecutor<TRawResponse = unknown> {
 ...
 */
export type SuccessResponse<TSuccessBody, TCode extends string, TRawResponse = unknown> = {
  success: true;
  body: TSuccessBody;
  code: TCode;
  raw: TRawResponse;
 ...
 */
export type ErrorResponse<TError, TCode extends string, TRawResponse = unknown> = {
  success: false;
  error: TError;
  code: TCode;
  raw: TRawResponse;
 ...
 */
export type UnexpectedErrorResponse<TRawResponse = unknown> = {
  success: false;
  error: unknown;
  code: number;
  raw?: TRawResponse;
