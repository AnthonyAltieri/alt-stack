...
| OpenAPI SDK generation | `@alt-stack/zod-openapi`, [`@alt-stack/effect-openapi`](packages/typescript-effect-openapi), Python packages `alt-stack-openapi-pydantic` and `alt-stack-http-client-httpx`, and Rust crates `rust-openapi` and `rust-openapi-crate-gen` |
