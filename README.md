...
| OpenAPI SDK generation | `@alt-stack/zod-openapi`, Python packages `alt-stack-openapi-pydantic` and `alt-stack-http-client-httpx`, and Rust crates `rust-openapi` and `rust-openapi-crate-gen` |
